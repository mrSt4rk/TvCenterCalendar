...
import { Calendar, Radio, Col, Row, Select, Spin } from 'antd';
...
const SCalendar = () => {
    ...
    const fetchItems = endpoint => {
        axios.get(endpoint).then(result => {
            ...
            setState({
                media: [...state.media, ...result.data.results.filter(item => item.origin_country.indexOf('US') !== -1)],
                loading: false,
    ...
    return (
        <div>
            <Spin spinning={state.loading}>
                ...
                <div className="saeed" style={{ marginTop: '20px', height: '100px', width: '500px' }}>salam
